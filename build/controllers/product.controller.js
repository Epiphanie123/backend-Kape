...
var createProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, price, description, inStock, newProduct, savedProduct, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name = _a.name, price = _a.price, description = _a.description, inStock = _a.inStock;
...
var getProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productmodel_1.default.findById(req.params.id)];
            case 1:
                product = _a.sent();
                if (!product)
...
var updateProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productmodel_1.default.findByIdAndUpdate(req.params.id, req.body, {
                        new: true,
                    })];
            case 1:
                product = _a.sent();
            ...
            case 2:
                error_4 = _a.sent();
                res.status(400).json({ message: "Update failed", error: error_4 });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var deleteProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productmodel_1.default.findByIdAndDelete(req.params.id)];
            case 1:
                product = _a.sent();
                if (!product)
                    return [2 /*return*/, res.status(404).json({ message: "Product not found" })];
