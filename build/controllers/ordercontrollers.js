...
var createOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, customerName, email, phone, address, products, totalPrice, order, savedOrder, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, customerName = _a.customerName, email = _a.email, phone = _a.phone, address = _a.address, products = _a.products, totalPrice = _a.totalPrice;
...
var getOrders = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order_1.Order.find().sort({ createdAt: -1 })];
            case 1:
                orders = _a.sent();
