...
var registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, fullname, email, password, userExists, hashedPassword, newUser, error_1;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                otp = user.generateResetPasswordOTP();
            ...
            case 3:
                ...
                return [4 /*yield*/, sendEmail(otp, email)];
            case 4:
                // Send OTP after saving
                _a.sent();
...
var resetPassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, otp, newPassword, user, hashedPassword, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
